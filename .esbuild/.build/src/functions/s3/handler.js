...
var openZipFile = (0, import_util.promisify)(yauzl.open.bind(yauzl));
var s3Handler = async (event) => {
  for (const record of event.Records) {
    const head = await S32.headObject({
